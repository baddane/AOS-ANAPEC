...
export const MOCK_CONVENTIONS: Convention[] = [
  ...
  {
    id: 'conv_akdital',
    title: 'Convention Médicale Groupe AKDITAL',
    partnerName: 'AKDITAL - Des soins et des liens',
    category: 'SANTE',
    description: 'Convention de partenariat entre AKDITAL et l\'AOS-ANAPEC couvrant l\'ensemble des actes de soins et services (hospitalisation, soin externe, radiologie et laboratoire) dans tous les hôpitaux, cliniques et centres du Groupe AKDITAL.',
    discountValue: '10% sur prestations ambulatoires',
    validityDate: '2028-05-15',
    contactPhone: '06 67 94 53 66',
    contactEmail: 'j.elfartass@akdital.ma',
    address: '258 Rte de L\'Oasis, Casablanca 20250',
    city: 'National',
    highlighted: true,
    signatureDate: '2026-05-15',
    duration: '2 ans renouvelable par tacite reconduction',
    partnerLogo: '🏥',
    beneficiaries: [
      'Les adhérents de l\'AOS ANAPEC',
      'Leurs conjoint(e)(s)',
      'Leur(s) enfant(s) à charge'
    ],
    establishments: [
      { name: 'Clinique Jerrada Oasis', code: 'CJO', city: 'Casablanca' },
      { name: 'Clinique Casablanca Ain Borja', code: 'CCAB', city: 'Casablanca' },
      { name: 'Centre International d\'Oncologie Casablanca', code: 'CIOC', city: 'Casablanca' },
      { name: 'Hôpital Privé Casablanca Ain Sebaa', code: 'HPC', city: 'Casablanca' },
      { name: 'Clinique Médico Chirurgical Longchamps', code: 'CMCL', city: 'Casablanca' },
      { name: 'Hôpital Privé d\'El Jadida', code: 'HPEJ', city: 'El Jadida' },
      { name: 'Clinique d\'Oncologie El Jadida', code: 'CIOJ', city: 'El Jadida' },
      { name: 'Clinique Atfal', code: 'CAT', city: 'Casablanca' },
      { name: 'Clinique Panorama Sidi Maarouf', code: 'CPSM', city: 'Casablanca' },
      { name: 'Hôpital International de Tanger', code: 'HPT', city: 'Tanger' },
      { name: 'Centre International d\'Oncologie Boughaz Tanger', code: 'CIOBT', city: 'Tanger' },
      { name: 'Hôpital International d\'Agadir', code: 'HIA', city: 'Agadir' },
      { name: 'Centre International d\'Oncologie d\'Agadir', code: 'CIOA', city: 'Agadir' },
      { name: 'Clinique des Spécialités Safi', code: 'CSS', city: 'Safi' },
      { name: 'Hôpital Privé de Salé', code: 'HPS', city: 'Salé' },
      { name: 'Centre international d\'Oncologie de Salé', code: 'COPS', city: 'Salé' },
      { name: 'Clinique de Bien être Bouskoura', code: 'CBB', city: 'Bouskoura' },
      { name: 'Clinique International Mohammedia', code: 'CIM', city: 'Mohammedia' },
      { name: 'Hôpital International de Fès', code: 'HIF', city: 'Fès' },
      { name: 'Centre International d\'Oncologie de Fès', code: 'CIOF', city: 'Fès' },
      { name: 'Hôpital Privé de Beni Mellal', code: 'HPBM', city: 'Beni Mellal' },
      { name: 'Clinique International de Khouribga', code: 'CIK', city: 'Khouribga' },
      { name: 'Hôpital International Ibn Nafis Marrakech', code: 'HIIN', city: 'Marrakech' },
      { name: 'Clinique International de Mogador', code: 'CIMO', city: 'Essaouira' },
      { name: 'Hôpital Privé de Tetouan', code: 'HPTE', city: 'Tetouan' },
      { name: 'Clinique International d\'Errachidia', code: 'CIE', city: 'Errachidia' },
      { name: 'Clinique International de Taroudant', code: 'CIT', city: 'Taroudant' },
      { name: 'Clinique International de Dakhla', code: 'CID', city: 'Dakhla' },
      { name: 'Hôpital International de Kénitra', code: 'HIK', city: 'Kénitra' },
      { name: 'Centre International d\'oncologie de Kénitra', code: 'CIOK', city: 'Kénitra' },
      { name: 'Hôpital International Meknès', code: 'HIM', city: 'Meknès' },
      { name: 'Centre International d\'Oncologie de Benguérir', code: 'CIOB', city: 'Benguérir' },
      { name: 'Hôpital Privé de Guelmim', code: 'HPG', city: 'Guelmim' },
      { name: 'Clinique Al Hikma', code: 'CAH', city: 'Casablanca' },
      { name: 'Polyclinique International de Laayoune', code: 'PIL', city: 'Laayoune' },
      { name: 'Centre International d\'oncologie Rabat', code: 'CIOR', city: 'Rabat' },
      { name: 'Hôpital Privé Ibn Yassine', code: 'HPIY', city: 'Rabat' },
      { name: 'Hôpital privé de Nador', code: 'HPN', city: 'Nador' },
      { name: 'Hôpital privé de Oujda', code: 'HPO', city: 'Oujda' },
      { name: 'Centre International d\'oncologie Oujda', code: 'CIOCO', city: 'Oujda' },
      { name: 'Anfa Prime Hospital', code: 'APH', city: 'Casablanca' }
    ],
    articles: [
      { number: 1, title: 'Objet', content: 'La présente convention de partenariat a pour objet de définir les conditions et les modalités de prise en charge des prestations de soins dispensées par AKDITAL au profit des adhérents de l\'AOS ANAPEC et de leurs ayants droits.', icon: '📋' },
      { number: 2, title: 'Bénéficiaires Éligibles', content: 'Les adhérents de l\'AOS ANAPEC, leurs conjoint(e)(s) et leur(s) enfant(s) à charge.', icon: '👨‍👩‍👧‍👦' },
      { number: 3, title: 'Désignation des établissements de santé', content: 'Les prestations couvertes sont dispensées par l\'ensemble des hôpitaux, cliniques et centres du Groupe AKDITAL, actuels et futurs.', icon: '🏥' },
      { number: 4, title: 'Prestations couvertes par la convention', content: 'Urgence 24/24, Réanimation/soins intensifs, Chirurgie générale, Chirurgie Cardio vasculaire, Oncologie, Actes de radiologie interventionnelle, Actes de cardiologie interventionnelle, Laboratoire, et d\'une façon générale tous les actes médicaux disponibles.', icon: '🩺' },
      { number: 5, title: 'Obligations des parties', content: 'AKDITAL s\'engage à assurer un accueil spécifique au profit des bénéficiaires et suivi rigoureux des dossiers. AOS-ANAPEC s\'engage à informer le personnel d\'AKDITAL des régimes de couverture santé et mettre à disposition un extrait de la base de données trimestriellement.', icon: '🤝' },
      { number: 6, title: 'Identification des bénéficiaires', content: 'L\'accès aux prestations sanitaires est conditionné par l\'accomplissement d\'une formalité administrative d\'identification (carte professionnelle, badge, C.I.N.) ainsi que la vérification des droits ouverts via l\'application SANLAM.', icon: '🪪' },
      { number: 7, title: 'Prise en charge', content: 'Toute hospitalisation fera l\'objet d\'une demande de prise en charge préalable transmise directement au patient. Le patient doit déposer une avance lors de son admission, restituée après réception de l\'accord de prise en charge.', icon: '📝' },
      { number: 8, title: 'Admission en urgence', content: 'Dans le cas d\'une hospitalisation en urgence, aucun document n\'est immédiatement exigible. Le patient peut être admis en attendant la réponse de la prise en charge via la plateforme SANLAM.', icon: '🚑' },
      { number: 12, title: 'Remise conventionnelle de 10%', content: 'Les établissements d\'AKDITAL offrent aux bénéficiaires une remise exclusive de 10% sur les prestations ambulatoires. Cette remise s\'applique exclusivement aux frais propres à la clinique.', icon: '🏷️' },
      { number: 13, title: 'Confidentialité & Protection des données', content: 'Les Parties s\'engagent à la confidentialité pendant toute la durée de la convention. Protection des données conformément à la loi N°09-08.', icon: '🔒' },
      { number: 15, title: 'Durée de la convention', content: 'La présente Convention est valable pour une durée de deux (2) ans à partir de la signature, renouvelable par tacite reconduction avec préavis de 2 mois.', icon: '📅' },
      { number: 18, title: 'Résiliation', content: 'La présente convention peut être résiliée à tout moment par l\'un ou l\'autre des signataires, sous réserve d\'un préavis de deux (2) mois.', icon: '🚫' }
    ],
    coveredServices: [
      'Urgence 24/24',
      ...
      'Laboratoire',
      'Tous les actes médicaux disponibles'
    ],
    requiredDocuments: [
      'Carte professionnelle ou badge ANAPEC',
      'Carte d\'identité nationale (C.I.N.)',
      'Vérification des droits via l\'application SANLAM',
      'Certificat médical ou pli confidentiel précisant la maladie',
      'Compte rendu d\'hospitalisation',
      'Copie de l\'accord de la prise en charge',
      'Prescription et résultats des examens radiologiques et biologiques',
      'Détail de la pharmacie consommée'
    ],
    partnerAddress: '258 Rte de L\'Oasis, Casablanca 20250',
    partnerPhone: '06 67 94 53 66',
    partnerEmail: 'j.elfartass@akdital.ma'
  }
];
